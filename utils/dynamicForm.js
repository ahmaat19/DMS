  ...
  return (
    <div className='mb-3'>
      <div className='row g-1 mb-3'>
        {data &&
          data.map((d) => (
            <div key={d && d._id} className='col-md-4 col-6'>
              <div className='form-check form-switch'>
                <input
                  {...register(
                    name,
                  ...
                  type='checkbox'
                  value={d && d._id}
                  id={`flexCheck${d && d._id}`}
                />
                <label
                  className='form-check-label mt-1'
                  htmlFor={`flexCheck${d && d._id}`}
                >
                  {d && d.name}
                </label>
              </div>
...
export const inputMultipleCheckBoxUpdated = (args) => {
  const { register, errors, name, data, label, isRequired = true } = args
  ...
  return (
    <div className='mb-3'>
      <div className='row g-1 mb-3'>
        {data &&
          data.map((d) => (
            <div key={d && d.test && d.test._id} className='col-md-4 col-6'>
              <div className='form-check form-switch'>
                <input
                  {...register(
                    name,
                  ...
                  className='form-check-input'
                  type='checkbox'
                  value={d && d.test && d.test._id}
                  id={`flexCheck${d && d.test && d.test._id}`}
                />
                <label
                  className='form-check-label mt-1'
                  htmlFor={`flexCheck${d && d.test && d.test._id}`}
                >
                  {d && d.test && d.test.name}
                </label>
              </div>
            </div>
          ))}
